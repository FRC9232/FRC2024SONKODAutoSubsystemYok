...
public final class Constants
{
  ...
  public static class Shooter{
    ...
    public static final double SHOOTER_VEL = 2800;    
    public static final double SHOOTER_AMPH = 0.25;
  ...
  public static class Intake{
    ...
    public static final double INTAKE_TO_SHOOTER_SPEED = 1.0;    
    public static final double INTAKE_AUTO_SPEED = 0.45;
