...
public class RobotContainer
{
  ...
  //Autonomous routines
  private final Command strategy_1 = drivebase.getAutonomousCommand("Middle_1_Note");  
  private final Command strategy_2 = drivebase.getAutonomousCommand("Middle_2_Note");  
  private final Command strategy_3 = drivebase.getAutonomousCommand("New Auto");
  
  private final Command sysIdAuto = drivebase.sysIdDriveMotorCommand();
  ...
  */                                  
    ...
    */
    ...
    m_chooser.setDefaultOption("Strategy 1", strategy_1);
    m_chooser.addOption("Strategy 2", strategy_2);
    m_chooser.addOption("Strategy 3", strategy_3);
    m_chooser.addOption("SysIDAuto", sysIdAuto);
    
    
    SmartDashboard.putData(m_chooser);
    SmartDashboard.putData("Run Intake", new IntakeSetCommand(intakeSubsystem, "intakeToShooter"));
...
/* 
    ...
    */
    ...
    limeTrigger.whileTrue(new msDrive(drivebase, limeSubsystem, 0.0, 0.0, 0.0, false, true));
    
    robotForwardTrigger.whileTrue(new msDrive(drivebase, limeSubsystem, 1.0, 0.0, 0.0, false, false));
    robotBackTrigger.whileTrue(new msDrive(drivebase, limeSubsystem, -1.0, 0.0, 0.0, false, false));
    robotLeftTrigger.whileTrue(new msDrive(drivebase, limeSubsystem, 0.0, -1.0, 0.0, false, false));
